...
app.config['MYSQL_DATABASE_PASSWORD'] = 'mehmet'
...
# Write a function named `home` which returns 'Welcome to the Mehmet's To-Do API Service',
# and assign to the static route of ('/')
# @app.route('/')
# def home():
#     return "Welcome to Mehmet's To-Do API Service"


@app.route("/")
def index():
    headers = request.args.get('bootcamp')
    if headers == "devops":
